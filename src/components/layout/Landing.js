    ...
    <div className='landing-container'>
        <div className='landing-entry-text-container'>
            <div className='landing-text-subcontainer'>
                ...
                <p>Plan and schedule your tasks, events or appointments, for one week, one month, or the entire year!</p>
        ...
        <div className='isometric-landing-container'>
            <img src={isoCalendar} alt="Isometric Calendar" className='isometric-landing-image'/>
        </div>
    </div>
);
